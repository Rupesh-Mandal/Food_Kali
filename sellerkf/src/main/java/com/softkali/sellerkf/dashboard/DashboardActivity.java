package com.softkali.sellerkf.dashboard;

import static com.softkali.sellerkf.dashboard.fragment.AllProductFragment.loadProduct;
...
public class DashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            FirebaseMessaging.getInstance().subscribeToTopic(String.valueOf(authSeller.getLong("id")));
            Log.e("abcd",String.valueOf(authSeller.getLong("id")));
        } catch (JSONException e) {
            e.printStackTrace();
        }
        try {
//            FirebaseMessaging.getInstance().subscribeToTopic("huuur");
            Log.e("abcd","seller id "+authSeller.getString("id"));
        } catch (JSONException e) {
            e.printStackTrace();
        }
