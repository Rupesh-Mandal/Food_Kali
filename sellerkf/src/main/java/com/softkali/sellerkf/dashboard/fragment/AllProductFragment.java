package com.softkali.sellerkf.dashboard.fragment;

import static com.softkali.sellerkf.dashboard.DashboardActivity.authSeller;
import static com.softkali.sellerkf.utils.Constant.deletProductUrl;
import static com.softkali.sellerkf.utils.Constant.getAllProductUrl;
...
import com.softkali.sellerkf.dashboard.activity.AddProductActivity;
import com.softkali.sellerkf.dashboard.activity.UpdateActivity;
import com.softkali.sellerkf.dashboard.adapter.ProductAdapter;
    ...
    private static void setProdduct(Activity activity) {
        ProductAdapter productAdapter=new ProductAdapter(activity, productArrayList, new ProductOnclick() {
            ...
            public void onDelet(Product product) {
                ...
                Picasso.get().load(product.getProductImageLink()).into(productImageLink);
