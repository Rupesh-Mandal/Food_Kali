...
import static com.softkali.sellerfk.utils.Constant.updateProductUrl;
...
import com.softkali.sellerfk.utils.ProductType;
    ...
    private void checkEdit() {
        if (productObject!=null){
            try {
                ...
                Glide.with(UpdateActivity.this).load(productObject.getString("productImageLink")).into(product_photo);
